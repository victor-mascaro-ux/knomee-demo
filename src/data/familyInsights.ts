...
export const familyToolkit: ToolkitTab = {
  ...
  starters: [
    {
      ...
      source: 'Future You — Emily’s coastal vision board and Sebastian’s time outdoors, fishing with the kids.',
    ...
    },
    {
      ...
      source: 'Key Highlights — both name the kids’ college; Sebastian wants to stay on track without giving up their retirement; Emily is saving for a second home.',
    ...
    },
    {
      ...
      source: 'Life Events — Emily’s career change and separation; Key Highlights — Sebastian values stability and keeping his word.',
    ...
    },
    {
      ...
      source: 'Future You — Emily’s “Coastal Life Dreams” board beside Sebastian’s joy in time outdoors and fishing.',
  ...
  words: {
    use: [
      { word: 'Family', hint: 'Both of them name it first among their core values' },
      { word: 'Security', hint: 'Sebastian values stability; Emily wants to feel secure through a transition' },
      { word: 'Freedom', hint: 'Emily’s word for what money is for' },
      { word: 'Together', hint: 'The household is the client here, not either half of it' },
      { word: 'Options', hint: 'College, retirement, a second home — they want choices kept open' },
      { word: 'Balance', hint: 'Sebastian wants work that leaves room for the rest of his life' },
      { word: 'Future', hint: 'Both of their concerns are about the kids’ future and their own' },
      { word: 'Flexibility', hint: 'Emily wants the flexibility to live generously' },
      { word: 'Peace Of Mind', hint: 'Relief from college and health worries runs through both answers' },
      { word: 'Home', hint: 'The beach house, and a home people feel welcomed into' },
    ],
    avoid: [
      { word: 'Aggressive', hint: 'Neither of them wrote about appetite for risk' },
      { word: 'Complex', hint: 'Emily asks for simplicity by name' },
      { word: 'High-risk', hint: 'Sebastian wants to stay on track — stability first' },
      { word: 'Pressure', hint: 'They are already holding college, health and aging parents at once' },
      { word: 'Optimization', hint: 'They talk about a life together, not about tuning numbers' },
      { word: 'Benchmarks', hint: 'Nothing they want is measured against a market' },
      { word: 'Products', hint: 'Their answers are about people and places, never products' },
      { word: 'Returns', hint: 'They are moved by time together, not by performance' },
      { word: 'Abstract jargon', hint: 'Emily asks for simplicity; plain words carry both of them' },
      {
