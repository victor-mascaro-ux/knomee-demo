...
export interface Step {
  ...
  stat?: string
  cta?: string
  /** An answer that stays with the advisor unless they choose to share it —
      the concerns they would rather hold close in a negotiation. */
  private?: boolean
...
export const advisorAdventures: AdvisorAdventure[] = [
  ...
  },
  {
    ...
    art: 'goals',
    minutes: 3,
    blurb: 'Say what move you’re considering and where you stand.',
    state: 'locked',
  },
]
...
export const steps: Step[] = [
  {
    ...
    lines: [
      ...
      { label: '3', value: 'Get your 3 most important questions. The three to put to any firm you are considering.' },
    ],
    stat: 'Est time: 8 min',
    cta: 'Get started',
  },
...
You’re making great progress. Let’s keep going.`,
  ...
  /* ── 5. The Move ── */
  {
    ...
    body: 'Writing your move down turns a vague intention into something you can act on. People who write down their goals are 42% more likely to achieve them.',
  ...
  },
  {
    ...
    kind: 'single',
    adventure: 'the-move',
    eyebrow: 'The Move · 1 of 11',
    title: 'What move are you considering?',
    body: 'Pick the one closest to what you have in mind.',
    options: [
  ...
  },
  {
    ...
    kind: 'single',
    adventure: 'the-move',
    eyebrow: 'The Move · 2 of 11',
    title: 'When would you want to make your move?',
  ...
  },
  {
    ...
    kind: 'text',
    adventure: 'the-move',
    eyebrow: 'The Move · 3 of 11',
    title: 'Why are you thinking about moving?',
    body: 'What’s pulling you toward it — or pushing you away from where you are?',
    answer:
  ...
  /* The brand the advisor built is a non-starter for many acquirers — most ask
     you to take on theirs. It is a huge decision, and "not sure" is an honest
     answer to it rather than a dodge, so it is an option of its own. */
  {
    id: 'mv-brand',
    kind: 'single',
    adventure: 'the-move',
    eyebrow: 'The Move · 5 of 11',
    title: 'Many firms ask you to take on their brand. How do you feel about letting go of yours?',
    body: 'You built it. There is no wrong answer here.',
    private: true,
    options: [
      'I’m ready to let it go',
      'Open to it, depending on the terms',
      'Not sure yet',
      'Keeping my brand is a must',
    ],
    chosen: ['Not sure yet'],
  },
  {
    ...
    kind: 'single',
    adventure: 'the-move',
    eyebrow: 'The Move · 6 of 11',
    title: 'Have you actively thought about making your move?',
    options: [
  ...
  },
  {
    ...
    kind: 'single',
    adventure: 'the-move',
    eyebrow: 'The Move · 8 of 11',
    title: 'Have you started to take action on your move?',
  ...
  },
  {
    ...
    kind: 'text',
    adventure: 'the-move',
    eyebrow: 'The Move · 9 of 11',
    title: 'Why might your move be worth it?',
  ...
  },
  {
    ...
    kind: 'text',
    adventure: 'the-move',
    eyebrow: 'The Move · 10 of 11',
    title: 'What might make your move challenging?',
  ...
  },
  {
    ...
    kind: 'multi',
    adventure: 'the-move',
    eyebrow: 'The Move · 11 of 11',
    title: 'Who else has a say in your decision to move?',
  ...
  },
  {
    ...
    title: 'What’s holding you back from deciding on your move?',
