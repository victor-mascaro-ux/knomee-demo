...
export default function App() {
  ...
  // Marcus's Advisor ID in the same frame. The firm side has its own
        ...
        candidateOpen ? (
          ...
          <main className="content">
            ...
            {firmScreen === 'firm-network' && (
              <FirmSoon
                title="My Network"
                body="Advisors who have joined the platform — Dynasty's Network Partners, and what each one's Advisor ID said before they signed."
              />
            )}
